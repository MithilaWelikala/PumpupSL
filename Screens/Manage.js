...
import community from '../assets/mmm.jpg';
        ...
        >
            ...
            <ScrollView style={Styles.scrollfoef}>
                ...
                <View style={Styles.viewfor}>
                    ...
                    >Manage Account{name}</Text>
                    <Text style={{fontSize: 15, color: 'white', fontWeight: '400'}}>Manage Profiles</Text>
                </View>
                ...
                <TouchableOpacity style={Styles.paycardt}>
                                            ...
                                            <View style={Styles.payments23}>
                                                ...
                                                <Text></Text>
                                                <Text>Update your Clients Accounts{"\n"}mont</Text>
                                            </View>
                </TouchableOpacity>
                ...
                <Text>
                                        ...
                                        >
                                            <Image source={community} style={Styles.payment23}/>
                                            <View style={Styles.payments23}>
                                                <Text style={Styles.textform1}>
                                                   Edit Admin{"\n"}Phone Number
                                                </Text>
